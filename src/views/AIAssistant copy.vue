                  ...
                  <template v-if="message.role === 'assistant'">
                    ...
                    <div class="max-w-[80%]">
                      <div class="bg-blue-50 rounded-lg p-4 inline-block">
                        ...
                        <button 
                          @click="textToSpeech(message.content)"
              ...
              <div class="relative">
                ...
                <div class="absolute right-2 bottom-2 flex space-x-2">
                  <input
                    type="file"
                    ref="audioFile"
                    @change="handleVoiceInput"
                    accept="audio/*"
                    class="hidden"
                  />
                  <button
                    @click="$refs.audioFile.click()"
                    class="p-2 text-gray-500 hover:text-blue-500 rounded-full hover:bg-gray-100"
                  >
...
const sendMessage = async () => {
  ...
  try {
    ...
    const response = await axiosInstance.post('/chat', chatRequest)
...
const handleVoiceInput = async (event) => {
  ...
  try {
    const response = await axiosInstance.post('/asr', formData)
